	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" method="post" action="register" autocomplete="off">
					...
					<div class="wrap-input100 validate-input"
						...
						<span class="label-input100">이름</span> <input class="input100"
							type="text" name="name" placeholder="Username"> <span
							class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input"
						...
						<span class="label-input100">전화번호</span> <input class="input100"
							type="text" name="phone" placeholder="Phone"> <span
							class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input">
						<span class="label-input100">알레르기</span>
					...
					<div class="container-login100-form-btn">
						<button type="button" 
							class="btn btn-success" id="update" onclick="location.href='../main'">뒤로가기</button>
						<input type="submit"
							class="btn btn-success" id="register" value="회원가입">
